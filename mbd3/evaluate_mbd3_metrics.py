#!/usr/bin/env python3
"""
Evaluate MBD3 EEG Baseline Model with Comprehensive Metrics
...
def calculate_comprehensive_metrics(predictions, targets, save_csv=True):
    ...
    if save_csv:
        ...
        combined_filename = 'mbd3_final_results.csv'
...
def evaluate_trained_model():
    ...
    print(f"\n📊 EVALUATING TRAINED MBD3 EEG BASELINE MODEL")
    print("=" * 60)
...
def main():
    ...
    print("🎯 MBD3 EEG COMPREHENSIVE METRICS EVALUATION")
    print("=" * 60)
    ...
    print(f"\n🎯 MBD3 EEG EVALUATION COMPLETED!")
    print(f"📁 Generated CSV files:")
    print(f"   - mbd3_detailed_metrics.csv")
    print(f"   - mbd3_summary_metrics.csv") 
    print(f"   - mbd3_final_results.csv")
