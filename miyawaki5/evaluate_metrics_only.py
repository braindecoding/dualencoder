#!/usr/bin/env python3
"""
Evaluate Miyawaki Baseline Model with Comprehensive Metrics
...
from simple_baseline_model import SimpleRegressionModel, MiyawakiBaselineDataset
...
def calculate_comprehensive_metrics(predictions, targets, save_csv=True):
    ...
    if save_csv:
        ...
        combined_filename = 'miyawaki5_final_results.csv'
...
def evaluate_trained_model():
    ...
    print(f"\n📊 EVALUATING TRAINED MIYAWAKI5 BASELINE MODEL")
    print("=" * 60)
    ...
    with torch.no_grad():
        for fmri_emb, images in tqdm(test_loader, desc="Generating predictions"):
...
def main():
    ...
    print("🎯 MIYAWAKI5 COMPREHENSIVE METRICS EVALUATION")
    print("=" * 60)
    print("🧠 Evaluating trained baseline model with comprehensive metrics")
    print("=" * 60)
    ...
    print(f"\n🎯 MIYAWAKI5 EVALUATION COMPLETED!")
    print(f"📁 Generated CSV files:")
    print(f"   - miyawaki5_detailed_metrics.csv")
    print(f"   - miyawaki5_summary_metrics.csv") 
    print(f"   - miyawaki5_final_results.csv")
